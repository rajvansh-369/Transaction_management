                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 top-right">
                                <h3 class="marginright">INVOICE-{{$ledger->bill_no}}</h3>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rs.{{$product->pivot->product_price}}</td>
                                        <td class="text-right">Rs.{{$product->pivot->product_qty * $product->pivot->product_price }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right pull-right invoice-total">
                                <p>Subtotal : Rs.{{$ledger->total_amount}}</p>
                                {{-- <p>Discount (10%) : $101 </p> --}}
                                {{-- <p>VAT (8%) : $73 </p> --}}
                                <p>Total : Rs.{{$ledger->total_amount}} </p>
                            </div>
                        </div>
